...
export default class AccountAddAddress extends Component {

    showTittleForm = () =>{
        const {isUpdate} = this.props;
        return isUpdate ? 'Chỉnh sửa địa chỉ' : 'Tạo địa chỉ';
    }

    render() {
        return (
            <div className="account__container--widget">
                <span className="account__title">{this.showTittleForm()}</span>
